...
class MoviesTableViewController: UITableViewController {
    ...
    var fechetedResulControll: NSFetchedResultsController<Movie>!
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if let vc = segue.destination as? MovieViewController {
            vc.movie = fechetedResulControll.object(at: tableView.indexPathForSelectedRow!)
        }
    }
    ...
    func loadMovies(){
        ...
        fechetedResulControll = NSFetchedResultsController(fetchRequest: fetchRequest, managedObjectContext: context, sectionNameKeyPath: nil, cacheName: nil)
        
           fechetedResulControll.delegate = self
        do {
            try fechetedResulControll.performFetch()
        } catch {
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        if let count = fechetedResulControll.fetchedObjects?.count {
    ...
    override func tableView(_ tableView: UITableView, editActionsForRowAt indexPath: IndexPath) -> [UITableViewRowAction]? {
        let more = UITableViewRowAction(style: .normal, title: "More") { action, index in
            print("more button tapped \(index)")
        }
        ...
        let share = UITableViewRowAction(style: .normal, title: "Share") { action, index in
            print("share button tapped \(index)")
        }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let movie = fechetedResulControll.object(at: indexPath)
    ...
    */
    ...
    override func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCellEditingStyle, forRowAt indexPath: IndexPath) {
        if editingStyle == .delete {
            ...
            context.delete(fechetedResulControll.object(at: indexPath))
            do {
                try context.save()
            } catch {
                print(error.localizedDescription)
